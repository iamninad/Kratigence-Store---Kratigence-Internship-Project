				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>".CURRENCY." $pro_price.00
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-primary btn-xs'>Add To Cart</button>
								</div>
							</div>
						</div>	
			";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="sb-xub9y4723253@business.example.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/Kratigence-store/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/Kratigence-store/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/Kratigence-store/cancel.php"/>
